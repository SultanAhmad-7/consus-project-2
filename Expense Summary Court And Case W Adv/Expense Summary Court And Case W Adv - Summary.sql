...
DECLARE @rptName varchar(100) = 'Expense Summary Court And Case W Adv - Summary';
DECLARE @rptDesc varchar(500) = 'Expense Summary Court And Case W Adv - Summary';
DECLARE @rptId varchar(50) = 'Expense Summary Court And Case W Adv - Summary';
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'tt_val', @newReport, N'TOTAL COURT COSTS AND CASE EXPENSES (COMBINED)', 0)
