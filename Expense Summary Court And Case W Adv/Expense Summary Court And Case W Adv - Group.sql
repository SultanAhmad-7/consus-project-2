...
DECLARE @rptName varchar(100) = 'Expense Summary Court And Case W Adv - Group';
DECLARE @rptDesc varchar(500) = 'Expense Summary Court And Case W Adv - Group';
DECLARE @rptId varchar(50) = 'Expense Summary Court And Case W Adv - Group';
...
format(sum(totl_val ),''c2'')  as tt_val
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'code', @newReport, N'Code', 0)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'tt_val', @newReport, N'SUBTOTAL', 1)
