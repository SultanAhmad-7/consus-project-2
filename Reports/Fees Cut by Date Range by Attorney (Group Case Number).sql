...
DECLARE @rptName varchar(100) = 'Fees Cut by Date Range by Attorney (Group Case Number)';
DECLARE @rptDesc varchar(500) = 'Fees Cut by Date Range by Attorney (Group Case Number)';
...
UNION 
 ...
 SELECT 
	...
	atty,
	class,
	(FORMAT((Payment_Goal), ''C2'') +'' ''+ p_g)  AS Payment_Goal,
	FORMAT(MAX(Settlement_Paid), ''C2'') AS Settlement_Paid,
	FORMAT(MAX(Settlement_Due), ''C2'') AS Settlement_Due
 FROM 
	cteAllData AS cte
 GROUP BY
	casenum,party_name,atty,class,p_g,Payment_Goal
 ORDER BY
	casenum;
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'atty', @newReport, N'Primary Staff', 2)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'class', @newReport, N'Class', 3)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Payment_Goal', @newReport, N'Payment/Goal Amount', 4)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Settlement_Paid', @newReport, N'Settlement Paid', 5)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Settlement_Due', @newReport, N'Settlement Due', 6)
