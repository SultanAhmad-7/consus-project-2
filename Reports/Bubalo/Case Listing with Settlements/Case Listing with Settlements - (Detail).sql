...
DECLARE @rptName varchar(100) = 'Case Listing with Settlements - (Detail)';
DECLARE @rptDesc varchar(500) = 'Case Listing with Settlements - (Detail)';
...
SELECT
	...
	FORMAT(TRY_CAST(date_settled AS DATE), ''MM/dd/yyyy'') AS dte_settled,
	FORMAT(actual, ''C2'') AS actual,
	FORMAT(TRY_CAST(start_date AS DATE), ''MM/dd/yyyy'') AS start_dte,
	description,
	FORMAT(total_value , ''C2'') AS total_value
FROM 
	cteAllData
ORDER BY 
	party_name ASC,
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'ps', @newReport, N'Primary Staff', 2)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'matcode', @newReport, N'Case Type', 3)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'dte_open', @newReport, N'Opened Date', 4)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'dte_settled', @newReport, N'Date Resolved', 5)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'actual', @newReport, N'Set $$$', 6)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'start_dte', @newReport, N'Value Date Service From', 7)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'description', @newReport, N'Value Code', 8)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'total_value', @newReport, N'Total Amount', 9)
