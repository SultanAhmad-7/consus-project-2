...
DECLARE @rptName varchar(100) = 'Cases Opened with Detail - (Detail)';
DECLARE @rptDesc varchar(500) = 'Cases Opened with Detail - (Detail)';
...
SELECT 
	...
	FORMAT(TRY_CAST(close_date AS date), ''MM/dd/yyyy'') AS dte_close,
	TEAM,
	staff_1,
	Injury_Severity,
	Transferred_FROM,
	FORMAT(TRY_CAST(Transfer_Date AS date), ''MM/dd/yyyy'') AS transfer_dte
FROM
	cteAllData
ORDER BY 
	Injury_Severity DESC,
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'dte_open', @newReport, N'Opened Date', 3)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'dte_close', @newReport, N'Close Date', 4)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'TEAM', @newReport, N'Team', 5)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'staff_1', @newReport, N'Attorney', 6)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Injury_Severity', @newReport, N'Injury Severity', 7)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Transferred_FROM', @newReport, N'Transferred From', 8)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'transfer_dte', @newReport, N'Transfer Date', 9)
