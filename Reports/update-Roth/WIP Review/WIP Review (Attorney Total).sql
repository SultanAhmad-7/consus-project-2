...
DECLARE @rptName varchar(100) = 'WIP Review (Attorney Total)';
DECLARE @rptDesc varchar(500) = 'WIP Review (Attorney Total)';
...
SELECT 
	...
	,FORMAT((sum(q1_2018_contract)+sum(q2_2018_contract)+sum(q3_2018_contract)+sum(q4_2018_contract)) / count ( casenum),''C2'') AS Avg_WIP_Case_Contract_Fee
	,FORMAT((sum(q1_2018_goal)+sum(q2_2018_goal)+sum(q3_2018_goal)+sum(q4_2018_goal)) / count( casenum), ''C2'') AS Avg_WIP_Case_Goal
	,FORMAT(((sum(q1_2018_goal)+sum(q2_2018_goal)+sum(q3_2018_goal)+sum(q4_2018_goal)) / count( casenum)) - ((sum(q1_2018_contract)+sum(q2_2018_contract)+sum(q3_2018_contract)+sum(q4_2018_contract)) / count ( casenum)) , ''C2'') AS reduction
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'tc', @newReport, N'Total Cases For Attorney', 0)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'staff_1', @newReport, N'Primary Staff', 1)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'dtc', @newReport, N'Total Cases for Group', 2)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'mini_amount', @newReport, N'Total Minimum Amount', 3)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'goal', @newReport, N'Total Goal', 4)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'actual', @newReport, N'Total Insurance Actual', 5)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'contract_fee', @newReport, N'Total Contract Fee', 6)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q1_2018_contract', @newReport, N'Total Q1 2021 Contract Fee', 7)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q1_2018_goal', @newReport, N'Total Q1 2021 Goal', 8)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q2_2018_contract', @newReport, N'Total Q2 2021 Contract Fee', 9)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q2_2018_goal', @newReport, N'Total Q2 2021 Goal', 10)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q3_2018_contract', @newReport, N'Total Q3 2021 Contract Fee', 11)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q3_2018_goal', @newReport, N'Total Q3 2021 Goal', 12)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q4_2018_contract', @newReport, N'Total Q4 2021 Contract Fee', 13)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q4_2018_goal', @newReport, N'Total Q4 2021 Goal', 14)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Avg_WIP_Case_Contract_Fee', @newReport, N'Avg WIP/Case Contract Fee', 15)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Avg_WIP_Case_Goal', @newReport, N'Avg WIP/Case Goal', 16)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'reduction', @newReport, N'Average Reduction', 17)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'total_contract_fee_wip', @newReport, N'2021 Total WIP Contract Fee', 18)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'total_goal_wip', @newReport, N'2021 Total WIP Goal', 19)
