...
DECLARE @rptName varchar(100) = 'Wip Review (Group By Case Number)';
DECLARE @rptDesc varchar(500) = 'Wip Review (Group By Case Number)';
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'dtc', @newReport, N'Total Cases For Attorny', 1)
