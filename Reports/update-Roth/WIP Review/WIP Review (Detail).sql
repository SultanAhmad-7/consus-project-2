...
DECLARE @rptName varchar(100) = 'WIP Review (Detail)';
DECLARE @rptDesc varchar(500) = 'WIP Review (Detail)';
...
SELECT 
	...
	,CONCAT(round((contract_percentage_data * 100),2), ''%'') AS cpercentage
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'policy_type', @newReport, N'Insurance Type', 2)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'mini_amount', @newReport, N'Minimum Amount', 3)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'goal', @newReport, N'Goal', 4)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'date_settled', @newReport, N'Date Resolved', 5)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'actual', @newReport, N'Insurance Actual', 6)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'contract_percentage_data', @newReport, N'Contract Percentage', 7)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'est_settlement_date', @newReport, N'Est Settlement Date', 8)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'contract_fee', @newReport, N'Contract Fee', 9)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q1_2018_contract', @newReport, N'Q1 2021 Contract Fee', 10)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q1_2018_goal', @newReport, N'Q1 2021 Goal', 11)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q2_2018_contract', @newReport, N'Q2 2021 Contract Fee', 12)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q2_2018_goal', @newReport, N'Q2 2021 Goal', 13)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q3_2018_contract', @newReport, N'Q3 2021 Contract Fee', 14)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q3_2018_goal', @newReport, N'Q3 2021 Goal', 15)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q4_2018_contract', @newReport, N'Q4 2021 Contract Fee', 16)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q4_2018_goal', @newReport, N'Q4 2021 Goal', 17)
