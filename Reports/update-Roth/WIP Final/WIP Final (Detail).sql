...
DECLARE @rptName varchar(100) = 'WIP Final (Detail)';
DECLARE @rptDesc varchar(500) = 'WIP Final (Detail)';
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'cpercentage', @newReport, N'Contract Percentage', 7)
