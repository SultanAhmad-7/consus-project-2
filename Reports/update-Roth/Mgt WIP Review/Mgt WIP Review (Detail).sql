...
DECLARE @rptName varchar(100) = 'Mgt WIP Review (Detail)';
DECLARE @rptDesc varchar(500) = 'Mgt WIP Review (Detail)';
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'policy_type', @newReport, N'Insurance Type', 5)
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'staff_1', @newReport, N'Primary Staff', 18)
