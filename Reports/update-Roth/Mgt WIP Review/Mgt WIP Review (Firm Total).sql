...
DECLARE @rptName varchar(100) = 'Mgt WIP Review (Firm Total)';
DECLARE @rptDesc varchar(500) = 'Mgt WIP Review (Firm Total)';
DECLARE @rptId varchar(50) = 'Mgt WIP Review';
...
AND (((@enter_atty is null) or ((SELECT staff.id FROM case_staff, staff, matter_staff WHERE cases.id = case_staff.casesid AND staff.id = case_staff.staffid 
...
AND (@Ins_Type_Parm is null OR (SELECT insurance_type.id FROM insurance_type WHERE insurance_type.id=insurance.insurancetypeid) in (@Ins_Type_Parm))
 ...
 SELECT 
	...
	,FORMAT((sum(q1_2018_contract)+sum(q2_2018_contract)+sum(q3_2018_contract)+sum(q4_2018_contract)),''C2'') as total_contract_fee_wip
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'dtc', @newReport, N'Total Cases For All', 0)

INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'mini_amount', @newReport, N'Total Minimum Amount For All', 1)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'goal', @newReport, N'Total Goal For All', 2)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'actual', @newReport, N'Total Insurance Actual For All', 3)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'contract_fee', @newReport, N'Total Contract Fee For All', 4)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q1_2018_contract', @newReport, N'Total Q1 2021 Contract Fee For All', 5)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q1_2018_goal', @newReport, N'Total Q1 2021 Goal For All', 6)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q2_2018_contract', @newReport, N'Total Q2 2021 Contract Fee For All', 7)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q2_2018_goal', @newReport, N'Total Q2 2021 Goal For All', 8)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q3_2018_contract', @newReport, N'Total Q3 2021 Contract Fee For All', 9)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q3_2018_goal', @newReport, N'Total Q3 2021 Goal For All', 10)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q4_2018_contract', @newReport, N'Total Q4 2021 Contract Fee For All', 11)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'q4_2018_goal', @newReport, N'Total Q4 2021 Goal For All', 12)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Avg_WIP_Case_Contract_Fee', @newReport, N'Avg WIP/Case Contract Fee For All', 13)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Avg_WIP_Case_Goal', @newReport, N'Avg WIP/Case Goal For All', 14)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'reduction', @newReport, N'Average Reduction For All', 15)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'total_contract_fee_wip', @newReport, N'2021 Total WIP Contract Fee For All', 16)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'total_goal_wip', @newReport, N'2021 Total WIP Goal For All', 17)
