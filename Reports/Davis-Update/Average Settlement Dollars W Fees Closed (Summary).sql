...
DECLARE @rptName varchar(100) = 'Average Settlement Dollars W Fees Closed (Summary)';
DECLARE @rptDesc varchar(500) = 'Average Settlement Dollars W Fees Closed (Summary)';
