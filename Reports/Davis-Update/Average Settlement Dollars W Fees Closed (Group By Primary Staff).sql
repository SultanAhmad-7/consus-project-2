...
DECLARE @rptName varchar(100) = 'Average Settlement Dollars W Fees Closed (Group By Primary Staff)';
DECLARE @rptDesc varchar(500) = 'Average Settlement Dollars W Fees Closed (Group By Primary Staff)';
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'staff_1', @newReport, N'Cases For', 1)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'tcg', @newReport, N'Total Cases', 2)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'ins_actual', @newReport, N'Total Acutal Amount', 3)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'avg_settlement', @newReport, N'Average $ Settlement/Case', 4)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'cse_costs', @newReport, N'Total Case Costs', 5)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'avg_cse_costs', @newReport, N'Case Cost Averages', 6)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'attorney_fee', @newReport, N'Total Attorney Fee', 7)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'avg_attorny_fee', @newReport, N'Attorney Fee Averages', 8)
