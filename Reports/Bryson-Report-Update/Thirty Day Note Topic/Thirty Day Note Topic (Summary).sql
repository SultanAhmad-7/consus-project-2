...
DECLARE @rptName varchar(100) = 'Thirty Day Note Topic (Summary)';
DECLARE @rptDesc varchar(500) = 'Thirty Day Note Topic (Summary)';
...
SELECT
	...
	,((COUNT(casenum)) - (SUM((CASE WHEN (Client_Contact IS NOT NULL  OR  Client_Contact <> '''') THEN 1 ELSE 0 END)))) AS TOTAL_CONTACT_NOT_IN
FROM
