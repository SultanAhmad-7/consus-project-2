...
DECLARE @rptName varchar(100) = 'Thirty Day Note Topic By Staff 1 (Detail)';
DECLARE @rptDesc varchar(500) = 'Thirty Day Note Topic By Staff 1 (Detail)';
...
WHERE 
 ...
 SELECT
	...
	,Staff_1
	,Party_Name
	,(CASE WHEN ((Client_Contacted IS NOT NULL) OR (Client_Contacted <> '''')) THEN 1 ELSE 0 END) AS Client_Contacted
 FROM
	cteAllData
 ORDER BY Staff_1;',@baseTableId)
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Staff_1', @newReport, N'Staff 1', 1)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'party_name', @newReport, N'First Party', 2)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Client_Contacted', @newReport, N'Client Contacted', 3)
