...
DECLARE @rptName varchar(100) = 'Cs Cases Transferred Out No Mt (Summary)';
DECLARE @rptDesc varchar(500) = 'Cs Cases Transferred Out No Mt (Summary)';
DECLARE @rptId varchar(50) = 'Cs Cases Transferred Out No Mt';
...
SELECT 
	...
	,cases.alt_case_num
FROM cases
	JOIN matter ON matter.id=cases.matterid AND matter.matcode <> ''MTM''
