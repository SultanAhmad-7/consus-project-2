...
DECLARE @rptName varchar(100) = 'Pi Demands Sent By Para Open Cases Only (Summary)';
DECLARE @rptDesc varchar(500) = 'Pi Demands Sent By Para Open Cases Only (Summary)';
