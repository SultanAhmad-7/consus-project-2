...
DECLARE @rptName varchar(100) = 'Pi Demands Sent All (Detail)';
DECLARE @rptDesc varchar(500) = 'Pi Demands Sent All (Detail)';
DECLARE @rptId varchar(50) = 'Pi Demands Sent All';
