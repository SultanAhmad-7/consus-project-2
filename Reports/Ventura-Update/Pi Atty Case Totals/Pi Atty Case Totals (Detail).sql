...
DECLARE @rptName varchar(100) = 'Pi Atty Case Totals (Detail)';
DECLARE @rptDesc varchar(500) = 'Pi Atty Case Totals (Detail)';
...
SELECT
	...
	,party_name
	,alt_case_num
	,FORMAT(try_cast(lim_date AS date), ''MM/dd/yyyy'') AS lim_dte
	,staff_1
	,staff_3
	,staff_8
	,FORMAT(try_cast(case_dte_3 AS date), ''MM/dd/yyyy'') AS cse_dte_3
	,staff_6
FROM
	cteAllData
ORDER BY
	stf_person,lit_status DESC,cse_dte_3;',@baseTableId)
-- insert the columns, one row per column in the select
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'stf_person', @newReport, N'Attorney', 0)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'lit_status', @newReport, N'Status', 1)
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'alt_case_num', @newReport, N'Notes', 4)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'lim_dte', @newReport, N'SOL', 5)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'staff_1', @newReport, N'Pre-Lit Para', 6)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'staff_3', @newReport, N'Lit Para', 7)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'staff_8', @newReport, N'Staff 8', 8)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'cse_dte_3', @newReport, N'Date Filed', 9)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'staff_6', @newReport, N'Staff 6', 10)
