...
DECLARE @rptName varchar(100) = 'Pi Atty Case List W Case Status (Summary)';
DECLARE @rptDesc varchar(500) = 'Pi Atty Case List W Case Status (Summary)';
...
WHERE 
 ...
 SELECT 
	COUNT(casenum) AS total_count
	,SUM(CASE WHEN classcode IS NULL or classcode = '''' THEN 1 ELSE 0 END) AS blank
	,SUM(CASE WHEN classcode = ''1'' THEN 1 ELSE 0 END) AS Intake_File_Setup
	,SUM(CASE WHEN classcode = ''2'' THEN 1 ELSE 0 END) AS Client_Treating
	,SUM(CASE WHEN classcode = ''3'' THEN 1 ELSE 0 END) AS Demand_Read
	,SUM(CASE WHEN classcode = ''4'' THEN 1 ELSE 0 END) AS In_Negotiation
	,SUM(CASE WHEN classcode = ''5'' THEN 1 ELSE 0 END) AS In_Discovery
	,SUM(CASE WHEN classcode = ''6'' THEN 1 ELSE 0 END) AS Settled
	,SUM(CASE WHEN classcode = ''7'' THEN 1 ELSE 0 END) AS Post_Disbursement
	,SUM(CASE WHEN classcode = ''8'' THEN 1 ELSE 0 END) AS Post_Judgment
 FROM cteAllData AS cte;',@baseTableId)

-- insert the columns, one row per column in the select
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'total_count', @newReport, N'Total Case', 0)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'blank', @newReport, N'Blank', 1)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Intake_File_Setup', @newReport, N'Intake/File Set-up', 2)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Client_Treating', @newReport, N'Client Treating', 3)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Demand_Read', @newReport, N'Demand Ready', 4)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'In_Negotiation', @newReport, N'In Negotiation', 5)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'In_Discovery', @newReport, N'In Discovery', 6)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Settled', @newReport, N'Settled', 7)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Post_Disbursement', @newReport, N'Post-Disbursement', 8)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Post_Judgment', @newReport, N'Post-Judgment', 9)
