...
DECLARE @rptName varchar(100) = 'Fees Cut by Date Range by Attorney (Summary)';
DECLARE @rptDesc varchar(500) = 'Fees Cut by Date Range by Attorney (Summary)';
...
UNION 
 ...
 SELECT
	FORMAT(SUM(Payment_Goal), ''C2'') AS Payment_Goal
	,FORMAT(SUM(Settlement_Paid), ''C2'') AS Settlement_Paid
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Payment_Goal', @newReport, N'Total Payment Goal', 0)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Settlement_Paid', @newReport, N'Total Settlement Paid', 1)
