...
DECLARE @rptName varchar(100) = 'Fees Cut By Date Range By Atty Final (Group)';
DECLARE @rptDesc varchar(500) = 'Fees Cut By Date Range By Atty Final (Group)';
...
WHERE
 ...
 SELECT 
	...
	staff_1,
	classcode,
	FORMAT(settle_paid, ''C2'') AS settle_paid,
	FORMAT(Settlement_Due, ''C2'') AS Settlement_Due,
	FORMAT(TRY_CAST(Settlement_Executed AS date), ''MM/dd/yyyy'') AS Settlement_Executed,
	FORMAT(SUM(PaymentAmount), ''C2'') AS PaymentAmount
 FROM
	cteAllData AS cte
 GROUP BY
	casenum,staff_1,settle_paid,Settlement_Due,classcode,party_name,Settlement_Executed
 ORDER BY
	casenum;
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'staff_1', @newReport, N'Atty', 2)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'classcode', @newReport, N'Class', 3)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'settle_paid', @newReport, N'Settlement Paid', 4)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Settlement_Due', @newReport, N'Settlement Due', 5)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'Settlement_Executed', @newReport, N'Client DSB', 6)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'PaymentAmount', @newReport, N'Payment Amount', 7)
