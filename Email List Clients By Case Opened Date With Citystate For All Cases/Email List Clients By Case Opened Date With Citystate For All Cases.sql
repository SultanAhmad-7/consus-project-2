...
DECLARE @rptName varchar(100) = 'Email List Clients By Case Opened Date With Citystate For All Cases';
DECLARE @rptDesc varchar(500) = 'Email List Clients By Case Opened Date With Citystate For All Cases';
DECLARE @rptId varchar(50) = 'Email List Clients By Case Opened Date With Citystate For All Cases';
...
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'[Party Name]', @newReport, N'Party Name', 1)
INSERT report_columns_orm (id, binding, reportid, name, col_order) VALUES (newid(), N'[Case #]', @newReport, N'Case #', 0)
